                ...
                <div class="w-[100%] h-[100%] row-start-2 grid gap-[14px]" style="grid-template-columns: 55% 45%">
                    ...
                    <div class="w-[100%] min-h-0 bg-white col-start-1 col-span-1 rounded-2xl grid overflow-hidden" style="grid-template-rows: 60px 60px 15fr">
                        ...
                        <div class="w-[100%] h-[100%] row-start-1 row-span-1 items-center text-[19px] font-semibold flex flex-row relative">
                            ...
                            <button @click="goToTilføjLagerPage" class="bg-[#0097ff] text-white w-fit text-[16px] rounded-lg p-2 right-2 absolute">Tilføj produkter</button>
                        </div>

                        <div class="w-[100%] h-[100%] bg-[#EAEEF3] row-start-2 row-span-1 grid items-center p-[18px] text-[14px] font-semibold text-[#9AA8BA]" style="grid-template-columns: 3fr 1fr 1fr 1fr 40px">
                    ...
                    <div class="w-[100%] min-h-0 bg-white col-start-2 col-span-1 rounded-2xl grid" style="grid-template-rows: 60px 60px 15fr">
                        ...
                        <div class="w-[100%] h-[100%] row-start-1 row-span-1 grid items-center text-[19px] font-semibold relative">
                            ...
                            <button @click="goToTilføjStockPage" class="bg-[#0097ff] text-white w-fit text-[16px] rounded-lg p-2 right-2 absolute">Tilføj lager</button>
                        </div>
