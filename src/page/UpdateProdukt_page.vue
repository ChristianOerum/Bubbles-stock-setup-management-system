<template>
    <div @click.self="goToLagerPage" class="bg-white w-screen h-screen flex flex-col justify-center items-center relative">
        ...
        <div class="bg-[#F1F7FF] w-auto h-auto rounded-xl flex flex-col justify-center p-5 items-right relative">
            ...
            <h1 class="font-semibold text-[24px] text-[#00214B] mb-2">Opdater produktnavn</h1>
            ...
            <button @click="updateProdukt" class="bg-[#0097ff] text-white w-fit text-[18px] font-semibold rounded-lg p-2 mt-[20px] right-2">Opdater</button>
    ...
    methods: {
        ...
        async updateProdukt(){
            try {
                ...
                console.error("ERROR updating " + this.$store.state.lager[this.$store.state.TempIndex].id + " from: produkter " + error);
            }
