<template>
    ...
    <div class="bg-white b-0 l-0 w-screen h-screen relative">
        ...
        <div class="bg-[#F1F7FF] bottom-0 right-0 left-[130px] top-[100px] h-auto w-auto absolute rounded-tl-[30px] p-[70px] ">
            ...
            <div class="w-[100%] h-[100%] grid gap-[14px]" style="grid-template-rows: 60px 93%">
                ...
                <div class="w-[100%] h-[100%] row-start-1 row-span-1 rounded-2xl flex flex-row">
                    ...
                    <div class="w-max h-[100%] bg-[#FCC3F7] text-black flex flex-col justify-center items-center rounded-xl font-semibold ml-2">
                        <p class="p-4 opacity-50">2 dage</p>
                    </div>

                    <div class="w-max h-[100%] bg-[#BEC4FE] text-black flex flex-col justify-center items-center rounded-xl font-semibold ml-2">
                        <p class="p-4 opacity-50">3 dage</p>
                    </div>

                    <div class="w-max h-[100%] bg-[#C5DBFF] text-black flex flex-col justify-center items-center rounded-xl font-semibold ml-2">
                        <p class="p-4 opacity-50">Denne uge</p>
                    </div>

                    <div class="w-max h-[100%] bg-[#BFF2FF] text-black flex flex-col justify-center items-center rounded-xl font-semibold ml-2">
                        <p class="p-4 opacity-50">2 Uger</p>
                    </div>

                    <div class="w-max h-[100%] bg-white text-black flex flex-col justify-center items-center rounded-xl font-semibold ml-2">
                        <p class="p-4 opacity-50">> 2 Uger</p>
                    </div>
                ...
                <div class="w-[100%] h-[100%] row-start-2 grid gap-[14px]" style="grid-template-columns: 55% 45%">
                    ...
                    <div class="w-[100%] min-h-0 bg-white col-start-1 col-span-1 rounded-2xl grid overflow-hidden" style="grid-template-rows: 60px 60px 15fr">

                        <div class="w-[100%] h-[100%] row-start-1 row-span-1 items-center text-[19px] font-semibold flex flex-row relative">
                        ...
                        <div class="w-[100%] h-[100%] bg-[#EAEEF3] row-start-2 row-span-1 grid items-center p-[18px] text-[14px] font-semibold text-[#9AA8BA]" style="grid-template-columns: 3fr 1fr 1.5fr 1fr 40px">
                            <h1 class="col-start-1 col-span-1">Opsætingsnavn</h1>
                            <h1 class="col-start-2 col-span-1">Oversigt</h1>
                            <h1 class="col-start-3 col-span-1">Status</h1>
                            <h1 class="col-start-4 col-span-1">Due Dato</h1>

                        </div>

                        <div class="w-[100%] h-[100%] row-start-3 row-span-1 overflow-y-scroll [&::-webkit-scrollbar]:hidden text-[#00214B]">
                    ...
                    <div class="w-[100%] min-h-0 bg-white col-start-2 col-span-1 rounded-2xl grid" style="grid-template-rows: 60px 60px 15fr">

                        <div class="w-[100%] h-[100%] row-start-1 row-span-1 grid items-center text-[19px] font-semibold relative">
